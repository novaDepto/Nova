...
1. Una línea base es la especificación de elementos de la configuración que han sido:
      <ul>
          ...
          <li>  <strong> Controlados:</strong> Para ser modificados deben de pasar por el <a href="https://github.com/novaDepto/Nova/wiki/%5BPRO07%5D-Proceso-de-Modificaci%C3%B3n-de-baseline"> Proceso de modificación de línea base </a> </li> 
      </ul>
